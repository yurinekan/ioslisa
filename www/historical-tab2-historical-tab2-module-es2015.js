...
let HistoricalTab2PageModule = class HistoricalTab2PageModule {
};
...
let HistoricalTab2Page = class HistoricalTab2Page {
    ...
    ionViewWillEnter() {
        ...
        this.service.getUserData(`api/v1/get-meals/${moment__WEBPACK_IMPORTED_MODULE_3__(this.h.initDate).subtract(1, 'days').format('YYYY-MM-DD')}`, this.header1, this.header2, this.header3).subscribe(data => {
...
HistoricalTab2Page.ctorParameters = () => [
...
//# sourceMappingURL=historical-tab2-historical-tab2-module-es2015.js.map