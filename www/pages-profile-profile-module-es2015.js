...
module.exports = "form {\n  padding: 5%;\n}\n\nion-button.left {\n  margin-right: 2.5vw;\n}\n\nion-button.right {\n  margin-left: 2.5vw;\n}\n\n.profile {\n  height: 170px;\n  width: 170px;\n}\n\n.profile-div {\n  border-style: solid;\n  border-radius: 8px;\n  border-width: 5px;\n  border-color: #3db6c5;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let ProfilePage = class ProfilePage {
    constructor(router, fBuilder, service, camera, actionSheetCtrl) {
        this.router = router;
    ...
    ionViewDidEnter() {
        ...
        this.service.getUserData('api/v1/users', this.header1, this.header2, this.header3).subscribe(resp => {
            ...
            this.emailUser = resp.body.user.email;
            this.birthUser = resp.body.client_detail_attributes.birthdate;
            //this.nome = this.nome.split(' ').length > 2 ? this.nome.split(' ').slice(0, -1).join(' '): this.nome;
            this.profile_picture_url = resp.body.user.image_url ? `${src_constants_constants__WEBPACK_IMPORTED_MODULE_5__["constants"].baseUrlProd}${resp.body.user.image_url}` : "../../../assets/imgs/unknown_user.png";
        });
    }
    ngOnInit() {
    ...
    submitForm() {
        //debugger
        this.service.updateUser('api/v1/users', parseInt(window.sessionStorage.getItem('id')), this.fGroup, this.header1, this.header2, this.header3).subscribe(data => {
    ...
    getImageFromGallery() {
        ...
        this.camera.getPicture(options).then((imageData) => {
            ...
            this.fGroup.value.image = 'data:image/jpeg;base64,' + imageData;
            this.profile_picture_url = this.fGroup.value.image;
        }, (err) => { });
    }
    getImageFromCamera() {
        const options = {
