...
let HistoricalTab3PageModule = class HistoricalTab3PageModule {
};
...
module.exports = "h2 {\n  margin-left: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let HistoricalTab3Page = class HistoricalTab3Page {
    ...
    ionViewWillEnter() {
        ...
        this.service.getUserData(`api/v1/get-meals/${moment__WEBPACK_IMPORTED_MODULE_2__(this.h.initDate).subtract(2, 'days').format('YYYY-MM-DD')}`, this.header1, this.header2, this.header3).subscribe(data => {
...
HistoricalTab3Page.ctorParameters = () => [
...
//# sourceMappingURL=historical-tab3-historical-tab3-module-es2015.js.map