...
var WaistMeasurePageModule = /** @class */ (function () {
    function WaistMeasurePageModule() {
    }
...
var WaistMeasurePage = /** @class */ (function () {
    function WaistMeasurePage(router, modalCtrl, service, loadingController, toastController) {
        this.router = router;
    ...
    WaistMeasurePage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.service.getUserData('api/v1/users', this.header1, this.header2, this.header3).subscribe(function (resp) {
            if (resp.status === 200 || resp.status === 201) {
                _this.weight_kg = String(resp.body.client_physicals_attributes[(resp.body.client_physicals_attributes.length - 1)].weight_kg);
                _this.waist_cm = String(resp.body.client_physicals_attributes[(resp.body.client_physicals_attributes.length - 1)].waist_cm);
                _this.height_m = String(resp.body.client_physicals_attributes[(resp.body.client_physicals_attributes.length - 1)].height_m);
                if (_this.height_m) {
                    _this.height_m = _this.height_m.replace(".", ",");
                }
                if (_this.weight_kg) {
                    _this.weight_kg = _this.weight_kg.replace(".", ",");
                }
                if (_this.waist_cm) {
                    _this.waist_cm = _this.waist_cm.replace(".", ",");
                }
            }
            else {
    ...
    WaistMeasurePage.prototype.submitForm = function () {
        var _this = this;
        ...
        this.service.updatePhysicals('api/auth', this.updateData, this.header1, this.header2, this.header3).subscribe(function (data) {
    ...
    WaistMeasurePage.prototype.showModal = function () {
    ...
    WaistMeasurePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-waist-measure-waist-measure-module-es5.js.map