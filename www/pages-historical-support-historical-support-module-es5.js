...
var HistoricalSupportPageModule = /** @class */ (function () {
    function HistoricalSupportPageModule() {
    }
    ...
    return HistoricalSupportPageModule;
}());
...
module.exports = "ion-content {\n  --overflow: scroll !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HistoricalSupportPage = /** @class */ (function () {
    function HistoricalSupportPage(service, router) {
    ...
    HistoricalSupportPage.prototype.ngOnInit = function () {
    };
    HistoricalSupportPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.toDoList = [];
        this.doneList = [];
        ...
        this.service.getUserData("api/v1/get-all-meals-by-user", this.header1, this.header2, this.header3).subscribe(function (resp) {
            console.log("CAFÉ DA MANHÃ É" + JSON.stringify(resp.body));
            if (resp.body.meals_ongoing != undefined) {
                _this.evaluationDoing = true;
                resp.body.meals_ongoing.forEach(function (element) {
                    _this.toDoList.push(element);
                });
            }
            if (resp.body.meals_finalized != undefined) {
                _this.evaluationDone = true;
                resp.body.meals_finalized.forEach(function (element) {
    ...
    ;
    HistoricalSupportPage.prototype.changePage = function (id, keepImage, description) {
    ...
    HistoricalSupportPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-historical-support-historical-support-module-es5.js.map