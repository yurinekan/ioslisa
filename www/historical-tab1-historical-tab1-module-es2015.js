...
let HistoricalTab1PageModule = class HistoricalTab1PageModule {
};
...
module.exports = "h2 {\n  margin-left: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let HistoricalTab1Page = class HistoricalTab1Page {
    constructor(h, router, service, imageCompress) {
        this.h = h;
        this.router = router;
    ...
    ionViewWillEnter() {
        ...
        this.service.getUserData(`api/v1/get-meals/${moment__WEBPACK_IMPORTED_MODULE_3__(this.h.initDate).format('YYYY-MM-DD')}`, this.header1, this.header2, this.header3).subscribe(data => {
            console.log("CAFÉ DA MANHÃ É" + JSON.stringify(data.body));
            //debugger
            data.body.forEach(element => {
                if (element.meal_type == "Café da Manhã") {
                    this.keepCafe = true;
                    this.keepImageCafe = `${_constants_constants__WEBPACK_IMPORTED_MODULE_6__["constants"].baseUrlProd}${element.image_url}`;
                    this.id_cafe = element.id;
                    this.description_cafe = element.description;
                }
                else if (element.meal_type == "Almoço") {
                    this.keepAlmoco = true;
                    this.keepImageAlmoco = `${_constants_constants__WEBPACK_IMPORTED_MODULE_6__["constants"].baseUrlProd}${element.image_url}`;
                    this.id_almoco = element.id;
                    this.description_almoco = element.description;
                }
                else if (element.meal_type == "Janta") {
                    this.keepJantar = true;
                    this.keepImageJantar = `${_constants_constants__WEBPACK_IMPORTED_MODULE_6__["constants"].baseUrlProd}${element.image_url}`;
                    this.id_jantar = element.id;
                    this.description_jantar = element.description;
                }
                else if (element.meal_type == "Ceia") {
                    this.keepCeia = true;
                    this.keepImageCeia = `${_constants_constants__WEBPACK_IMPORTED_MODULE_6__["constants"].baseUrlProd}${element.image_url}`;
...
HistoricalTab1Page.ctorParameters = () => [
...
//# sourceMappingURL=historical-tab1-historical-tab1-module-es2015.js.map