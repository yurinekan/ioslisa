...
var HistoricalTab4PageModule = /** @class */ (function () {
    function HistoricalTab4PageModule() {
    }
    ...
    return HistoricalTab4PageModule;
}());
...
module.exports = "h2 {\n  margin-left: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HistoricalTab4Page = /** @class */ (function () {
    function HistoricalTab4Page(h, router, service) {
        this.h = h;
        this.router = router;
        this.service = service;
    }
    HistoricalTab4Page.prototype.ionViewWillEnter = function () {
        var _this = this;
        ...
        this.service.getUserData("api/v1/get-meals/" + moment__WEBPACK_IMPORTED_MODULE_2__(this.h.initDate).subtract(3, 'days').format('YYYY-MM-DD'), this.header1, this.header2, this.header3).subscribe(function (data) {
    ...
    HistoricalTab4Page.prototype.changePage = function (id, keepImage, description) {
    ...
    HistoricalTab4Page.prototype.ngOnInit = function () {
    };
    HistoricalTab4Page.ctorParameters = function () { return [
...
//# sourceMappingURL=historical-tab4-historical-tab4-module-es5.js.map