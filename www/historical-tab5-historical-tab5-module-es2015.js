...
let HistoricalTab5PageModule = class HistoricalTab5PageModule {
};
...
let HistoricalTab5Page = class HistoricalTab5Page {
    ...
    ionViewWillEnter() {
        ...
        this.service.getUserData(`api/v1/get-meals/${moment__WEBPACK_IMPORTED_MODULE_2__(this.h.initDate).subtract(4, 'days').format('YYYY-MM-DD')}`, this.header1, this.header2, this.header3).subscribe(data => {
...
HistoricalTab5Page.ctorParameters = () => [
...
//# sourceMappingURL=historical-tab5-historical-tab5-module-es2015.js.map